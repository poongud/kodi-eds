...
## Environments
- Preview: https://main--kodi-eds--poongud.aem.page/
- Live: https://main--kodi-eds--poongud.aem.live/
...
1. Open the `kodi-eds` directory in your favourite IDE and start coding :)
